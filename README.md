...
The server automatically exposes all public methods from [CyberEduClient](https://github.com/CyberEDU-Cyber-Range/cyberedu-client.git) as MCP tools. Tools are prefixed with `cyberedu_` to avoid naming conflicts.
...
The server uses Python's `inspect` module to automatically discover all public methods from the [CyberEduClient](https://github.com/CyberEDU-Cyber-Range/cyberedu-client.git) class. For each method:
...
1. **Add methods to CyberEduClient**: Simply add new public methods to the [CyberEduClient](https://github.com/CyberEDU-Cyber-Range/cyberedu-client.git) class
